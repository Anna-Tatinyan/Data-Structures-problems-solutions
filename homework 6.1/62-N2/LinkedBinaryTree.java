...
class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
      ...
      void iterativePreorder() {
        if (root == null)
          return;
        Stack<Position<E>> positionStack = new Stack<Position<E>>();
        positionStack.push(root);
        while (positionStack.empty() == false) {
          Position<E> current = positionStack.peek();
          System.out.print(current.getElement() + " ");
          positionStack.pop();
          if (right(current) != null) {
            positionStack.push(right(current));
          }
          if (left(current) != null) {
            positionStack.push(left(current));
          }
        }
      }
